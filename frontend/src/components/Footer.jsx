...
const Footer = () => {
    return (
        <div>
            <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-0 sm:mt-40 text-sm">
                <div>
                    ...
                    <p className='w-full md:w-2/3 text-gray-600'>
                        Kunjungi buletin kami untuk mendapatkan pembaruan tentang informasi rilis produk terbaru!
                    </p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <ul className='flex flex-col gap-1 text-gray-600'>
                        ...
                        <li className='cursor-pointer hover:text-black transition-all duration-300 hover:translate-x-1'>
                            ...
                            +62 (8)9692 070270</li>
                        <li className='cursor-pointer hover:text-black transition-all duration-300 hover:translate-x-1'><FontAwesomeIcon icon={faEnvelope} style={{ marginRight: '10px' }} />az_denim@gmail.com</li>
                        <li className='cursor-pointer hover:text-black transition-all duration-300 hover:translate-x-1'><FontAwesomeIcon icon={faInstagram} style={{ marginRight: '10px' }} />@AZ.denim</li>
            ...
            <div>
                <hr />
                <p className='py-5 text-size-sm text-center'>Copyright 2024 - AZ Denim - All Right Reserved.</p>
            </div>
        </div>
    )
}
